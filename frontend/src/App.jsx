...
const uiText = {
  es: {
    ...
    heroTitle: "MVP2 Business + Technical Studio",
    ...
    myIdeasSubtitle: "Solo ves ideas creadas con tu sesion. Incluye fase y motivo de rechazo.",
    statusDetail: "Estado",
    ...
    adminPanelTitle: "Panel admin MVP3",
  ...
  en: {
    ...
    adminPanelTitle: "MVP3 admin panel",
  ...
  pt: {
    ...
    adminPanelTitle: "Painel admin MVP3",
              ...
              {selectedIdea ? (
                ...
                >
                  ...
                  {selectedIdea.architecture_package && (
                    <>
                      <p className="meta">
                        {t.packageGenerated}. {t.packageGeneratedAt}: {new Date(selectedIdea.architecture_package.generated_at).toLocaleString()}
                      </p>
                      <button
                        type="button"
                        onClick={() => handlePreviewArchitecturePackage(selectedIdea)}
                      >
                        {t.viewPackage}
                      </button>
                      <button
                        type="button"
                        onClick={() => handleDownloadArchitecturePackage(selectedIdea)}
                      >
                        {t.downloadPackage}
                      </button>
                    </>
                  ...
                  <details className="idea-detail" style={{ marginTop: 12 }}>
                    ...
                    {selectedIdea.architecture_package && (
                      <>
                        <p className="meta">{t.architectureSummary}: {selectedIdea.architecture_package.summary}</p>
                        <p className="meta">
                          {t.componentsLabel}: {(selectedIdea.architecture_package.components || []).map((component) => component.name).join(" | ") || "-"}
                        </p>
                        <p className="meta">
                          {t.adminTopComponents}: {(selectedIdea.architecture_package.suggested_component_catalog || []).map((component) => component.name).join(" | ") || "-"}
                        </p>
                      </>
                    )}
